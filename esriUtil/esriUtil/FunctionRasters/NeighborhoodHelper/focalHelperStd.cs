...
namespace esriUtil.FunctionRasters.NeighborhoodHelper
{
    class focalHelperStd : focalFunctionDatasetBase
    {
        ...
        //        float uVl = System.Convert.ToSingle(Math.Sqrt((nSmallArrValue2 - ((nSmallArrValue * nSmallArrValue) / windowN)) / windowN));
        ...
        //            try
        //            {
        //                uVl = System.Convert.ToSingle(Math.Sqrt((nSmallArrValue2 - ((nSmallArrValue * nSmallArrValue) / windowN)) / windowN));
        ...
        //        float uVl = System.Convert.ToSingle(Math.Sqrt((vl2 - ((vl * vl) / windowN)) / windowN));
