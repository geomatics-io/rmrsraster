...
{
    class neighborhoodHelperUniqueRectangle
    {
                ...
                for (int nBand = 0; nBand < pbBig.Planes; nBand++)
                {
                    ...
                    for (int j = 0; j < pbBigWd; j++)
                    {
                        ...
                        if (cl >= 0)
                        {
                            ...
                            pixelValues.SetValue(clmsDic.Count, cl, 0);
                        }
                    ...
                    for (int i = rws; i < pbBigHt; i++)
                    {
                        ...
                        pixelValues.SetValue(clmsDic.Count, 0, rw);
                    }
                    ...
                    for (int i = rws; i < pbBigHt; i++)
                    {
                        ...
                        for (int k = clms; k < pbBigWd; k++)
                        {
                            ...
                            pixelValues.SetValue(clmsDic.Count, cl, rw);
                        }
                    }
