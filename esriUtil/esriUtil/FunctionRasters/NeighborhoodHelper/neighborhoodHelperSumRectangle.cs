...
{
    class neighborhoodHelperSumRectangle
    {
                ...
                for (int nBand = 0; nBand < pbBig.Planes; nBand++)
                {
                    ...
                    for (int j = 0; j < pbBigWd; j++)
                    {
                        ...
                        if (cl >= 0)
                        {
                            ...
                            pixelValues.SetValue(clmsSum, cl, 0);
                        }
                    }
                    ...
                    for (int i = rws; i < pbBigHt; i++)
                    {
                        ...
                        for (int k = 0; k < clms; k++)
                        {
                            ...
                            clmsValues[k,rw] =rwsSum;
                            clmsSum += rwsSum;
                        }
                        pixelValues.SetValue(clmsSum, 0, rw);
                    }
                    ...
                    for (int i = rws; i < pbBigHt; i++)
                    {
                        ...
                        for (int k = clms; k < pbBigWd; k++)
                        {
                            ...
                            clmsSum = clmsSum - oldClmsValues;
                            pixelValues.SetValue(clmsSum, cl, rw);
                        }
                    }
