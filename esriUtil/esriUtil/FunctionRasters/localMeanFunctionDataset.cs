...
{
    class localMeanFunctionDataset: IRasterFunction
    {
        public localMeanFunctionDataset()
        {
        }
        ...
        private string myName = "LocalMean Function"; // Name of the log Function.
        private string myDescription = "Transforms a raster using local mean value transformation"; // Description of the log Function.
            ...
            try
            {
                ...
                for (int i = pBRowIndex; i < pBHeight; i++)
                {
                    for (int k = pBColIndex; k < pBWidth; k++)
                    {
                        ...
                        outArr.SetValue(sumVls / outPb.Planes, k, i);
                    }
                }
