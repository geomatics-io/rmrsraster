...
{
    class clusterFunctionGaussianDataset : IRasterFunction
    {
        ...
        private Statistics.dataPrepClusterGaussian cluster = null;
        ...
        public void Bind(object pArgument)
        {
            if (pArgument is clusterFunctionArguments)
            {
                ...
                cluster = (Statistics.dataPrepClusterGaussian)arg.ClusterModel;
