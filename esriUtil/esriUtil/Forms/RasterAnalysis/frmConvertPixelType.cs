...
{
    public partial class frmConvertPixelType : Form
    {
        public frmConvertPixelType(IMap map)
        {
            InitializeComponent();
        ...
        public frmConvertPixelType(IMap map,ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
        ...
        private void btnClip_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                outraster = rsUtil.convertToDifFormatFunction(rst,pType);
                if (mp != null&&addToMap)
                {
