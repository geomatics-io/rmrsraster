...
{
    public partial class frmNullToValue : Form
    {
        public frmNullToValue(IMap map)
        {
            InitializeComponent();
        ...
        public frmNullToValue(IMap map, ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
        ...
        private void btnClip_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                outraster = rsUtil.createRaster(rsUtil.setnullToValueFunction(rst,vl));
                if (mp != null && addToMap)
                {
