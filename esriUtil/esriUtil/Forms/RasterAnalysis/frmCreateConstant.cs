...
{
    public partial class frmCreateConstant : Form
    {
        public frmCreateConstant(IMap map)
        {
            InitializeComponent();
        ...
        public frmCreateConstant(IMap map, ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
        ...
        private void btnClip_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                outraster = rsUtil.constantRasterFunction(rst,vl);
                if (mp != null && addToMap)
                {
