...
{
    public partial class frmTasseledCap : Form
    {
        public frmTasseledCap(IMap map)
        {
            InitializeComponent();
        ...
        public frmTasseledCap(IMap map, ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
        ...
        private void btnClip_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                outraster = rsUtil.returnRaster(rsUtil.calcTasseledCap7Function(rst));
                if (mp != null && addToMap)
                {
