...
{
    public partial class frmShiftRaster : Form
    {
        public frmShiftRaster(IMap map)
        {
            InitializeComponent();
        ...
        public frmShiftRaster(IMap map, ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
