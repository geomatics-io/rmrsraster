...
{
    public partial class frmMathRaster : Form
    {
        public frmMathRaster(IMap map)
        {
            InitializeComponent();
        ...
        public frmMathRaster(IMap map,ref rasterUtil rasterUtility, bool AddToMap)
        {
            InitializeComponent();
        ...
        private void populateComboBox()
        {
            ...
            foreach (string s in Enum.GetNames(typeof(rasterUtil.transType)))
            {
