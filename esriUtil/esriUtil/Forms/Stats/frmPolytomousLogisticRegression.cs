...
{
    public partial class frmPolytomousLogisticRegression : Form
    {
        public frmPolytomousLogisticRegression(IMap map)
        {
            InitializeComponent();
            mp = map;
            if (mp != null)
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            double alpha = System.Convert.ToInt32(nudStay.Value);
