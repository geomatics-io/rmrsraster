...
{
    public partial class frmLandscapeMetrics : Form
    {
        ...
        {
            string lTyp = rasterUtil.landscapeType.REGION.ToString();
            if (cmbMetric.Text == lTyp)
            {
                label4.Visible = false;
                cmbFocalStat.Visible = false;

            }
            else
            {
                label4.Visible = true;
                cmbFocalStat.Visible = true;
            }
        }
    }
}
