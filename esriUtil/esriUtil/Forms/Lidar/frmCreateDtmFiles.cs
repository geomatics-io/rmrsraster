...
{
    public partial class frmCreateDtmFiles : Form
    {
        public frmCreateDtmFiles(ESRI.ArcGIS.Carto.IMap mp, rasterUtil rasterUtility = null)
        {
            InitializeComponent();
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            rp.addMessage("Running grid surface create. This may take a while...");
            rp.stepPGBar(10);
            rp.TopMost = true;
            rp.Show();
            try
            {
                ...
                fsInt.RunGridSurfaceCreate(lasDir,gLasDir,cellSize);
            ...
            finally
            {
                ...
                rp.stepPGBar(100);
                rp.addMessage("Finished creating DTMs in" + t);
                rp.enableClose();
                this.Close();
            }
        }
